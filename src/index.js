...
// entradas.forEach((cadaEntrada) => {
//   cadaEntrada.onclick=(e) => {
//     e.target.parentNode.querySelector('entradas').classList.remove("hidden");
...
//   let cadaEntrada = [entradas[i]];
//   todasEntradas.forEach((ed) => {
//     ed.onclick = (evns) => {
//       evns.cadaEntrada.classList.remove("hidden");
//       evns.cadaEntrada.classList.add("active");
//     }
//   }) 
//   // cadaEntrada.addEventListener('click', () => {
    
//   //   if (cadaEntrada.classList = 'active') {
//   //     (cadaEntrada+1).classList.remove("hidden");
//   //     (cadaEntrada+1).classList.add("active");
//   // }
//   actualizarBarraPorcentaje();
//   // })
  
// }
// console.log(todasEntradas);


// todasEntradas.forEach((input) => {
//   input.onclick = (e) => {
//     let siguienteInput = input;
